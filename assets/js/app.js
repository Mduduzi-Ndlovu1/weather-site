    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        card.innerHTML = `
            ...
            <div class="weapper">
                ...
                <img src="./assets/images/weather_icons/${icon}.png" alt="${description}" class="weather-icon" width="64" height="64">
            </div>
            <p class="meta-list">${description}</p>
            <ul class="meta-list">
                <li class="meta-item">
                    ...
                    <div class="wrapper">
                        ...
                        <ul class="card-list">
                            ...
                            <li class="card-item">
                                ...
                                <p class="label-1">SO <sub>2.3</sub></p>
                            </li>
                            <li class="card-item">
                                <p class="title-1">${no2.toPrecision()}</p>
                                <p class="label-1">NO <sub>2</sub></p>
                            </li>
                            <li class="card-item">
                                <p class="title-1">${o3.toPrecision()}</p>
